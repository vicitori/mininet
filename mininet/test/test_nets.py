...
class testSingleSwitchCommon(object):
    ...
    def testMinimal(self):
        ...
        mn = Mininet(
            SingleSwitchTopo(), self.switchClass, Host, Controller, waitConnected=True
        )
...
class testLinearCommon(object):
    ...
    def testLinear5(self):
        ...
        mn = Mininet(
            LinearTopo(k=5), self.switchClass, Host, Controller, waitConnected=True
        )
        dropped = mn.run(mn.ping)
        self.assertEqual(dropped, 0)
